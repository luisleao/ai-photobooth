...
Pose: os dois bracos devem estar abertos, um para cada lado, com as maos posicionadas perto das extremidades inferiores da armação retangular de gol. As maos devem estar fechadas como punhos, com somente o dedo indicador de cada mao estendido. O indicador esquerdo deve apontar diretamente para a extremidade inferior do poste esquerdo, no canto inferior esquerdo da armação do gol. O indicador direito deve apontar diretamente para a extremidade inferior do poste direito, no canto inferior direito da armação do gol. Os indicadores nao devem apontar para o meio dos postes, para o travessao superior ou para o centro do gol. Nao fazer sinal de quadrado com as maos. Nao juntar as maos na frente do peito.
...
Trave obrigatoria: desenhe apenas a parte frontal da trave do gol, como um contorno plano em formato de U invertido ou letra grega pi: poste esquerdo, poste direito e travessao superior. Nao desenhe perspectiva, profundidade, postes laterais, barras traseiras, linha inferior, rede, grade, malha, quadriculado, fios, sombras de rede ou qualquer linha interna dentro do gol. A area interna do gol deve ficar limpa e transparente, exceto pelo balao "VAR".
