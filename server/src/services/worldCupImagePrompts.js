...
Enquadramento obrigatorio da coroa: a coroa e parte essencial da figurinha e deve aparecer 100% visivel dentro do canvas. Deixe uma margem transparente ampla acima da coroa e nas laterais. Nao corte a ponta superior, joias, estrelas, bordas laterais ou qualquer detalhe da coroa. Se necessario, reduza levemente o tamanho da pessoa e afaste o enquadramento para caber cabeca, coroa inteira, ombros, bracos e maos. A coroa deve ficar sobre a cabeca, centralizada, sem sair para fora do quadro e sem encostar nas bordas do canvas.
Enquadramento geral: a pessoa inteira e a coroa devem aparecer completamente dentro da imagem, com margem transparente ao redor. Nao corte cabeca, coroa, bracos, maos, ombros ou qualquer parte importante da silhueta.
...
Roupa obrigatoria: cada pessoa selecionada deve aparecer vestindo uma camiseta de jogo do Brasil generica, preferencialmente amarela com detalhes verdes e acabamento esportivo moderno. ${jerseyInstruction}
...
Direcao de arte: hiper-realista e fotografica, como uma foto editorial esportiva premium em estudio, pele natural, textura real de tecido, iluminacao profissional, profundidade e nitidez de impressao. A pessoa ou grupo deve parecer real, nao cartoon, nao 3D estilizado, nao caricatura, nao ilustracao.
