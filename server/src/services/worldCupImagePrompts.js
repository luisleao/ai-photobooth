...
Checklist final de acessorios: antes de finalizar o cartao, compare a regiao dos olhos com a foto original. Se a pessoa nao usa oculos na referencia, a imagem final tambem deve ficar sem oculos, sem armação, sem lentes e sem hastes. Se a pessoa usa oculos reais, eles devem continuar com o mesmo modelo e as mesmas regioes de cor da referencia. A troca da camiseta nao autoriza trocar, recolorir, simplificar, esportivizar, adicionar ou redesenhar os oculos. Se alguma parte da armacao original for preta, escura, transparente, amarela, verde, fosca, brilhante ou bicolor, mantenha essa parte exatamente assim.
