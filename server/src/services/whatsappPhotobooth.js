...
async function handleWhatsAppWebhook(req, res) {
  ...
  try {
    ...
    twiml.message('Envie uma foto por aqui para gerar sua figurinha da Copa e o pacote de stickers.');
    return sendTwiml(res, twiml);
  } catch (error) {
